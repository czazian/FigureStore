<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeFile="AddStaff.aspx.cs" Inherits="Assignment.Staff.AddStaff" %>
    ...
    <div class="home-content">
        <div class="sales-boxes">
            ...
            <div class="recent-sales box">
                <div class="title" style="padding-bottom: 10px; font-size: 30px; font-weight: 600; color: #ff7e29"><i class="bx bx-user-plus"></i>&nbsp;Add New Staff</div>
                ...
                <asp:Button runat="server" ID="btnBack" Text="Back" CssClass="form-button" PostBackUrl="~/Staff/Staff.aspx" CausesValidation="False" />
                <br />
