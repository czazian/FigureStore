<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeFile="ViewOrder.aspx.cs" Inherits="Assignment.Staff.ViewOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sales-boxes">
        ...
        <div class="recent-sales box">
            ...
            <div class="title" style="color: #ff7e29;"><i class="bx bx-user"></i>&nbsp;Customer Info</div>
            <br />
        ...
        <!--                        customer info-->
        <div class="recent-sales box">
            <div class="title" style="color: #ff7e29;"><i class="bx bx-store-alt"></i>&nbsp;Order Detail</div>
            </br>
    ...
    <div class="sales-boxes">
        <div class="recent-sales box">
            <div class="title" style="color: #ff7e29;"><i class="bx bx-shopping-bag"></i>&nbsp;Order List</div>
