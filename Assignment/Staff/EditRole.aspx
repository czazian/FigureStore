<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeFile="EditRole.aspx.cs" Inherits="Assignment.Staff.EditRole" %>
    ...
    <div class="home-content">
        <div class="sales-boxes">
            ...
            <div class="recent-sales box">
                ...
                <div class="title" style="padding-bottom: 10px; font-size: 30px; font-weight: 600; color: #ff7e29"><i class="bx bx-street-view"></i>&nbsp;Edit Role</div>
                ...
                <asp:Button runat="server" ID="btnBack" Text="Back" CssClass="form-button" PostBackUrl="~/Staff/Role.aspx" CausesValidation="False" />
            </div>
