<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeFile="EditStaff.aspx.cs" Inherits="Assignment.Staff.EditStaff" %>
    ...
    <div class="home-content">
        <div class="sales-boxes">
            ...
            <div class="recent-sales box">
                ...
                <div class="title" style="padding-bottom: 20px; font-size: 30px; font-weight: 600; color: #ff7e29"><i class="bx bx-user-check"></i>&nbsp;Edit Staff</div>
                ...
                <br>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorPassword" runat="server" ControlToValidate="txtNewPassw" ErrorMessage="This field is required" ForeColor="Red"></asp:RequiredFieldValidator>
                    <br />
                    <br />
                    <label class="label-field">Role/Position : </label>
                </br>
                <asp:DropDownList runat="server" ID="ddlRole" CssClass="input-field" DataSourceID="SqlDataSource1" DataTextField="RoleName" DataValueField="AdminRoleID">
