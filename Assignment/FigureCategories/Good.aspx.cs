    ...
    public partial class Good : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (status == "all")
            {
                ...
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Goods' ";
            }
            else if (status == "pre")
            {
                RadioButtonList.SelectedIndex = 1;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Goods' AND FigureStatus = 'Pre-Order'";
            }
            else if (status == "available")
            {
                RadioButtonList.SelectedIndex = 2;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Goods' AND FigureStatus = 'Available'";
            }
            ...
            if (gundam.HasRows)
            {
                goodRepeater.DataSource = gundam;
                goodRepeater.DataBind();

                resultno.Text = goodRepeater.Controls.Count + " Results";
            }
            else
            {
            ...
            conn2.Open();
            string allManufacturer = "SELECT DISTINCT [FigureManufacturer] FROM FIGURE WHERE [FigureCategory] = 'Goods' ";
            ...
            conn3.Open();
            string allSeries = "SELECT DISTINCT [FigureSeries] FROM FIGURE WHERE FigureCategory = 'Goods'";
        ...
        protected void RadioButtonList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (result.HasRows)
            {
                goodRepeater.DataSource = result;
                goodRepeater.DataBind();

                resultno.Text = goodRepeater.Controls.Count.ToString() + " Results";
            }
            else
            {
                resultno.Text = "0" + " Results";
        ...
        protected void cbxManufacturer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string commandManufacturer = "SELECT * FROM Figure WHERE [FigureCategory] = 'Goods' AND FigureManufacturer IN(";
            conn5.Open();
            ...
            if (itemsSelected.Count != 0)
            {
                ...
                if (mresult.HasRows)
                {
                    ...
                    goodRepeater.DataSource = mresult;
                    goodRepeater.DataBind();
        ...
        protected void cbxSeries_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<ListItem> itemsSelected = cbxSeries.Items.Cast<ListItem>()
                                                    ...
                                                    .ToList();
            //resultno.Text = itemsSelected.Count + " Results";
            string commandSeries = "SELECT * FROM Figure WHERE [FigureCategory] = 'Goods' AND FigureSeries IN(";
            conn4.Open();
            ...
            if (itemsSelected.Count != 0)
            {
                ...
                if (sresult.HasRows)
                {
                    ...
                    goodRepeater.DataSource = sresult;
                    goodRepeater.DataBind();
        ...
        protected void Apply_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string cmdPrice = "SELECT * FROM Figure WHERE FigureCategory = 'Goods' AND FigurePrice >= @min AND FigurePrice <= @max;";
                    ...
                    if (reader.HasRows)
                    {
                        goodRepeater.DataSource = reader;
                        goodRepeater.DataBind();
                        resultno.Text = goodRepeater.Controls.Count.ToString() + " Results";
                    }
                    else
                    {
                        goodRepeater.DataSource = "";
                        goodRepeater.DataBind();
                        resultno.Text = "0" + " Results";
                    }
                }
        ...
        protected void ddlSort_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string cmdSort = "SELECT * FROM Figure WHERE FigureCategory = 'Goods'";
