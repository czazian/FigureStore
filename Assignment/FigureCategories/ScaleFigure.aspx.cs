...
{
    public partial class ScaleFigure : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (status == "all")
            {
                ...
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Scale Figures' ";
            }
            else if (status == "pre")
            {
                RadioButtonList.SelectedIndex = 1;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Scale Figures' AND FigureStatus = 'Pre-Order'";
            }
            else if (status == "available")
            {
                RadioButtonList.SelectedIndex = 2;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Scale Figures' AND FigureStatus = 'Available'";
            }
            ...
            if (gundam.HasRows)
            {
                ScaleFigureRepeater.DataSource = gundam;
                ScaleFigureRepeater.DataBind();

                resultno.Text = ScaleFigureRepeater.Controls.Count + " Results";
            }
            else
            {
            ...
            conn2.Open();
            string allManufacturer = "SELECT DISTINCT [FigureManufacturer] FROM FIGURE WHERE [FigureCategory] = 'Scale Figures' ";
            ...
            conn3.Open();
            string allSeries = "SELECT DISTINCT [FigureSeries] FROM FIGURE WHERE FigureCategory = 'Scale Figures'";
        ...
        protected void RadioButtonList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Main Operation
            ScaleFigureRepeater.DataSource = null;
            ScaleFigureRepeater.DataBind();
            SqlConnection conn2;
            string str = ConfigurationManager.ConnectionStrings["ApexOnlineShopDb"].ConnectionString;
            ...
            if (result.HasRows)
            {
                ScaleFigureRepeater.DataSource = result;
                ScaleFigureRepeater.DataBind();

                resultno.Text = ScaleFigureRepeater.Controls.Count.ToString() + " Results";
            }
            else
            {
                resultno.Text = "0" + " Results";
        ...
        protected void cbxManufacturer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string commandManufacturer = "SELECT * FROM Figure WHERE [FigureCategory] = 'Scale Figures' AND FigureManufacturer IN(";
            conn5.Open();
            ...
            if (itemsSelected.Count != 0)
            {
                ...
                if (mresult.HasRows)
                {
                    ...
                    ScaleFigureRepeater.DataSource = mresult;
                    ScaleFigureRepeater.DataBind();
        ...
        protected void cbxSeries_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<ListItem> itemsSelected = cbxSeries.Items.Cast<ListItem>()
                                                    ...
                                                    .ToList();
            //resultno.Text = itemsSelected.Count + " Results";
            string commandSeries = "SELECT * FROM Figure WHERE [FigureCategory] = 'Scale Figures' AND FigureSeries IN(";
            conn4.Open();
            ...
            if (itemsSelected.Count != 0)
            {
                ...
                if (sresult.HasRows)
                {
                    ...
                    ScaleFigureRepeater.DataSource = sresult;
                    ScaleFigureRepeater.DataBind();
        ...
        protected void Apply_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string cmdPrice = "SELECT * FROM Figure WHERE FigureCategory = 'Scale Figures' AND FigurePrice >= @min AND FigurePrice <= @max;";
                    ...
                    if (reader.HasRows)
                    {
                        ScaleFigureRepeater.DataSource = reader;
                        ScaleFigureRepeater.DataBind();
                        resultno.Text = ScaleFigureRepeater.Controls.Count.ToString() + " Results";
                    }
                    else
                    {
                        ScaleFigureRepeater.DataSource = "";
                        ScaleFigureRepeater.DataBind();
                        resultno.Text = "0" + " Results";
                    }
                }
        ...
        protected void ddlSort_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string cmdSort = "SELECT * FROM Figure WHERE FigureCategory = 'Scale Figures'";
            ...
            if (r.HasRows)
            {
                ScaleFigureRepeater.DataSource = r;
                ScaleFigureRepeater.DataBind();
            }
        }
    }
