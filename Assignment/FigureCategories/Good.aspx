<%@ Page Title="" Language="C#" MasterPageFile="~/Cust.Master" AutoEventWireup="true" CodeBehind="Good.aspx.cs" Inherits="Assignment.FigureCategories.Good" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box">
        <div class="header-cont">
            <asp:Image runat="server" ImageUrl="~/Image/Element/longbanner5.jpg" />
            <div class="header-tt">
                GOODS
            </div>
        </div>
            ...
            <div class="right">
                <div class="items-cont">
                    ...
                    <div class="item-container">
                        ...
                        <asp:Repeater runat="server" ID="goodRepeater">
                            <ItemTemplate>
                                <!--An Item-->
                                <div class="item">
