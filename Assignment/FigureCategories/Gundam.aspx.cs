    ...
    public partial class Gundam : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (status == "all")
            {
                ...
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Gundam' " ;
            }
            else if (status == "pre")
            {
                RadioButtonList.SelectedIndex = 1;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Gundam' AND FigureStatus = 'Pre-Order'";
            }
            else if (status == "available")
            {
                RadioButtonList.SelectedIndex = 2;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Gundam' AND FigureStatus = 'Available'";
            }
        ...
        protected void cbxManufacturer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string commandManufacturer = "SELECT * FROM Figure WHERE [FigureCategory] = 'Gundam' AND FigureManufacturer IN(";
            conn5.Open();
        ...
        protected void cbxSeries_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<ListItem> itemsSelected = cbxSeries.Items.Cast<ListItem>()
                                                    ...
                                                    .ToList();
            //resultno.Text = itemsSelected.Count + " Results";
            string commandSeries = "SELECT * FROM Figure WHERE [FigureCategory] = 'Gundam' AND FigureSeries IN(";
            conn4.Open();
        ...
        protected void Apply_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string cmdPrice = "SELECT * FROM Figure WHERE FigureCategory = 'Gundam' AND FigurePrice >= @min AND FigurePrice <= @max;";
        ...
        protected void ddlSort_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string cmdSort = "SELECT * FROM Figure WHERE FigureCategory = 'Gundam'";
