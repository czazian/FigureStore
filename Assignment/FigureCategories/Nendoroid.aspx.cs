...
{
    public partial class Nendoroid : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (status == "all")
            {
                ...
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Nendoroids' ";
            }
            else if (status == "pre")
            {
                RadioButtonList.SelectedIndex = 1;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Nendoroids' AND FigureStatus = 'Pre-Order'";
            }
            else if (status == "available")
            {
                RadioButtonList.SelectedIndex = 2;
                retrieve = "SELECT * FROM FIGURE WHERE [FigureCategory] = 'Nendoroids' AND FigureStatus = 'Available'";
            }
            ...
            if (gundam.HasRows)
            {
                nendoroidRepeater.DataSource = gundam;
                nendoroidRepeater.DataBind();

                resultno.Text = nendoroidRepeater.Controls.Count + " Results";
            }
            else
            {
            ...
            conn2.Open();
            string allManufacturer = "SELECT DISTINCT [FigureManufacturer] FROM FIGURE WHERE [FigureCategory] = 'Nendoroids' ";
            ...
            conn3.Open();
            string allSeries = "SELECT DISTINCT [FigureSeries] FROM FIGURE WHERE FigureCategory = 'Nendoroids'";
        ...
        protected void RadioButtonList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Main Operation
            nendoroidRepeater.DataSource = null;
            nendoroidRepeater.DataBind();
            SqlConnection conn2;
            string str = ConfigurationManager.ConnectionStrings["ApexOnlineShopDb"].ConnectionString;
            ...
            if (result.HasRows)
            {
                nendoroidRepeater.DataSource = result;
                nendoroidRepeater.DataBind();

                resultno.Text = nendoroidRepeater.Controls.Count.ToString() + " Results";
            }
            else
            {
                resultno.Text = "0" + " Results";
        ...
        protected void cbxManufacturer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string commandManufacturer = "SELECT * FROM Figure WHERE [FigureCategory] = 'Nendoroids' AND FigureManufacturer IN(";
            conn5.Open();
            ...
            if (itemsSelected.Count != 0)
            {
                ...
                if (mresult.HasRows)
                {
                    ...
                    nendoroidRepeater.DataSource = mresult;
                    nendoroidRepeater.DataBind();
        ...
        protected void cbxSeries_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<ListItem> itemsSelected = cbxSeries.Items.Cast<ListItem>()
                                                    ...
                                                    .ToList();
            //resultno.Text = itemsSelected.Count + " Results";
            string commandSeries = "SELECT * FROM Figure WHERE [FigureCategory] = 'Nendoroids' AND FigureSeries IN(";
            conn4.Open();
            ...
            if (itemsSelected.Count != 0)
            {
                ...
                if (sresult.HasRows)
                {
                    ...
                    nendoroidRepeater.DataSource = sresult;
                    nendoroidRepeater.DataBind();
        ...
        protected void Apply_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string cmdPrice = "SELECT * FROM Figure WHERE FigureCategory = 'Nendoroids' AND FigurePrice >= @min AND FigurePrice <= @max;";
                    ...
                    if (reader.HasRows)
                    {
                        nendoroidRepeater.DataSource = reader;
                        nendoroidRepeater.DataBind();
                        resultno.Text = nendoroidRepeater.Controls.Count.ToString() + " Results";
                    }
                    else
                    {
                        nendoroidRepeater.DataSource = "";
                        nendoroidRepeater.DataBind();
                        resultno.Text = "0" + " Results";
                    }
                }
        ...
        protected void ddlSort_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string cmdSort = "SELECT * FROM Figure WHERE FigureCategory = 'Nendoroids'";
            ...
            if (r.HasRows)
            {
                nendoroidRepeater.DataSource = r;
                nendoroidRepeater.DataBind();
            }
        }
    }
